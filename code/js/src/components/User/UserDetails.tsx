...
export function UserDetailsView({user, updateUser}) {
    ...
    //updateUser("", userState.avatarUrl)
                        ...
                        isEditing ? (
                            <form onSubmit={handleSubmit}>
                                <div className="relative">
                                    <input className="w-32 text-gray-900 inline-flex rounded" type="text"
                                           placeholder="new name..." onChange={handleChange} value={userName}></input>
                                    <button className="absolute inset-y-0 right-0" type="submit">✔️
                                    </button>
                                </div>
                            </form>) : (
                            <div className="relative">
                                <h1 className="inline-flex">{userName}</h1>
                                <button className="absolute inset-y-0 right-0" onClick={() => {
                                    setIsEditing(true)
                                }}>✏️
                                </button>
                            </div>
