...
INSERT INTO match (isprivate, board, created_at, player_black, player_white, winner_id)
VALUES (false, 'match_board_1', NOW(), 1, 2, 1),
       (true, 'match_board_2', NOW(), 2, 3, 3),
       (false, 'match_board_3', NOW(), 1, 3, 1);
