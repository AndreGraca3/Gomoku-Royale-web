...
@Component
class AuthenticationInterceptor(/*private val authorizationHeaderProcessor: RequestTokenProcessor*/) : HandlerInterceptor {

    override fun preHandle(request: HttpServletRequest, response: HttpServletResponse, handler: Any): Boolean {
        if (handler is HandlerMethod && handler.hasMethodAnnotation(Auth::class.java)) {
